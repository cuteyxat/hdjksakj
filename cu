...
<div class="container">
    <!--bow-->
    <div class="bow animated" id="bow"> <img src="https://xatimg.com/image/p6rOX2lhZgPr.png" alt="bow" class="animated slideInDown forward" width="200"> </div> <img src="img/pinkbg.jpg" class="pink-bg" width="2000">
    <aside class="profile-card">
        <header>
            <!-- my avatar -->
            <a target="_blank" href="index.html"><img src="https://xatimg.com/image/Gok4JiFzY4Bo.jpg" class="hoverZoomLink" id="avatar"></a>
            <!-- the username -->
...
body {
  overflow: hidden;
  background: #BF9AA6 no-repeat center center fixed;
